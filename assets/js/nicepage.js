    ...
    (ResponsiveMenu.prototype.init = function init() {
      ...
      (ResponsiveMenu.fixDirection = function t(e, el) {
        ...
        if (a.length) {
          a.removeClass(i + " " + o);
          var s = "";
          if (a.parents("." + i).length) s = i;
          else if (a.parents("." + o).length) s = o;
          if (s) a.addClass(s);
          else {
            var l = a.offset().left,
              u = a.outerWidth();
            if (l < 0) a.addClass(o);
            else if (l + u > n(e).outerWidth()) a.addClass(i);
          }
        }
      }),
     ...
     * Copyright (c) 2019 Dmitry Semenov; */ !(function (a, factory) {
      ...
      var t = function (template, t, items, e) {
        ...
        var l = function () {
          ...
          $t = function () {
            for (var t in zt) if (zt.hasOwnProperty(t)) Nt(t);
          },
    ...
    n(function () {
      ...
      (window._npInitMenuLink = function t(e, i) {
        var o = n("body"),
          ...
          nav,
          u = e.closest(".u-menu").attr("data-submenu-level") || "on-click",
          c = e.attr("href") || "",
        ...
        if (!v || "#" === v || !n(v).length)
          if (
            (h && window.location.href.toString() === f) ||
            (m && p === m) ||
            (l && h === l)
          ) {
